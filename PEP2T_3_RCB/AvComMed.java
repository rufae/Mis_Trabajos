...
public class AvComMed extends Aeronave{
    AvComMed(String cod_aparato, String fecha_entrega, String linea_montaje, Integer horas_previstas, Integer horas_empleadas, Integer capacidad_pasajeros, Double coste, Double precio_venta){
